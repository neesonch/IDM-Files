...
// Clicking a directional command in the HTML document runs the below code to move Theseus which checks if the intended move 
...
//alert (board [0][0].canGoUp);
//alert ("c"+minotaur.row+minotaur.col);
